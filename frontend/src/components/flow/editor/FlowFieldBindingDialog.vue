...
<template>
  ...
  >
    <div
      data-flow-field-binding-dialog
      class="flex max-h-[85vh] w-full max-w-xl flex-col overflow-hidden rounded-2xl border bg-card p-6 text-card-foreground shadow-2xl"
      role="dialog"
      aria-modal="true"
